...
class BuaAnNhe extends Component {
    goBack() {
        this.props.navigation.goBack();
    }
    gotothisListFood(){
        const thamso='Bữa ăn nhẹ'
...
function mapStateToProps(state){
    return {myCaloNhe:state.calonhe}
}
export default connect(mapStateToProps)(BuaAnNhe)
