...
class BuaTrua extends Component {
    goBack() {
        this.props.navigation.goBack();
    }
    gotothisListFood(){
        const thamso='Bữa trưa'
...
function mapStateToProps(state){
    return {myCaloTrua:state.calotrua}
}
export default connect(mapStateToProps)(BuaTrua)
